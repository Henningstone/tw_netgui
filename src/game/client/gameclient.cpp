...
void CGameClient::OnReset()
{
	...
	// TODO: NetGui. This is not pretty.
...
void CGameClient::OnMessage(int MsgId, CUnpacker *pUnpacker)
{
	...
	else if(MsgId == NETMSGTYPE_SV_NETGUI_REMOVEELEMENT) // TODO: NetGui
	{
	...
	else if(MsgId == NETMSGTYPE_SV_NETGUI_UIRECT)
	{
		...
		Client()->m_NetGuiUIRect.add_unsorted(e);
	...
	else if(MsgId == NETMSGTYPE_SV_NETGUI_LABEL)
	{
		...
		// save the element and resort the list
		Client()->m_NetGuiLabel.add_unsorted(e);
	...
	else if(MsgId == NETMSGTYPE_SV_NETGUI_BUTTONMENU)
	{
		...
		// save the element and resort the list
		Client()->m_NetGuiButtonMenu.add_unsorted(e);
